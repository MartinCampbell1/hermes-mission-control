...
function buildTheme(config: ThemeConfig): Theme {
  ...
  return createTheme({
    ...
    typography: {
      fontFamily:
        '-apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", "Inter", "Roboto", "Helvetica", "Arial", sans-serif',
      h1: { fontSize: '1.75rem', fontWeight: 600, color: text.primary },
      h6: { fontSize: '1rem', fontWeight: 600, color: text.primary },
      body1: { fontSize: '0.92rem', lineHeight: 1.68, color: text.primary },
...
const hermesConfig: ThemeConfig = {
  name: 'Hermes',
  primary: { main: '#7C5CFF', light: '#9B83FF', dark: '#6A4AF0', contrastText: '#ffffff' },
  secondary: { main: '#10A37F', light: '#34C6A2', dark: '#0B7F63', contrastText: '#ffffff' },
  error: { main: '#EF4444', light: '#F87171', dark: '#DC2626' },
  warning: { main: '#F59E0B', light: '#FBBF24', dark: '#D97706' },
  info: { main: '#3B82F6', light: '#60A5FA', dark: '#2563EB' },
  success: { main: '#22C55E', light: '#4ADE80', dark: '#16A34A' },
  background: { default: '#2A2A2A', paper: '#232323' },
  ...
  sidebar: {
    ...
    selectedText: '#ECECEC',
    selectedBorder: '#7C5CFF',
  },
  card: {
    background: '#303030',
    selectedBackground: '#343434',
    shadow: 'none',
    selectedShadow: 'none',
    hoverShadow: 'none',
  },
